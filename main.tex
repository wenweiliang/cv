...
% Tagline
{
    ...
    Genome engineer and computational biologist aiming to unravel the epigenetic mechanisms governing tumor progression through integrated experimental and computational approaches.\par
}
...
\begin{entrylist}
    ...
    \textbf{Rising Stars Symposium} \hfill The Salk Institue, SD, 2025 \\
...
\item Taiwan Ministry of Education Fellowship (\$10,000) \hfill 2007--2008
\end{entrylist}

\section{Honors \& Awards}

\begin{detaillist}
\item Outstanding postdoctoral fellow, Rising Stars Symposium, The Salk Institute
    \hfill 2025
\item Outstanding Contribution Award, New York Genome Center
    \hfill 2024
\item NYU Postdoctoral Travel Grant Award, New York University
    \hfill 2024
...
\item Outstanding student from a low-income background, Lu Feng-Zhang Memorial Scholarship
    \hfill
    2006
...
{\small Mentored an underrepresented student on a project focused on identifying long noncoding RNAs essential for macrophage differentiation and polarization using \textit{in vitro} CRISPR pooled screening.}
\begin{detaillist}
...
\begin{entrylist}
    ...
    {\small Organized and coordinated monthly seminars featuring presentations by postdoctoral researchers.}
